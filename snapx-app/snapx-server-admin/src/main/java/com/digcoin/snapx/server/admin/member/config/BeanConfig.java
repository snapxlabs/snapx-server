package com.digcoin.snapx.server.admin.member.config;
...
public class BeanConfig {
    ...
    public BlockingQueueManager<MemberAccessEvent> memberAccessEventQueue() {
        return new BlockingQueueManager<>("memberAccessEventQueue", redissonClient, new JsonJacksonCodec(objectMapper), false);
    }
    ...
    public BlockingQueueManager<MemberSignUpEvent> memberSignUpEventQueue() {
        return new BlockingQueueManager<>("memberSignUpEventQueue", redissonClient, new JsonJacksonCodec(objectMapper), false);
    }
